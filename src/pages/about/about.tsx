...
import HeroImage from '../../assets/images/giving2-e1443270113333.jpg'
  ...
  render() {
    return (
      <div className="bc-about-page">
        <Header background={HeroImage} height="40%">
          <h1>OUR STORY</h1>
        </Header>
        ...
        <main>
          ...
          <section>
              <div className="content values">
                ...
                <Button variant="contained" link="http://www.adventist.org/beliefs/">Our Beliefs</Button>

                {/* <a mat-raised-button className="center" href="http://www.adventist.org/beliefs/" (click)="believe()">Our Beliefs</a> */}
              </div>
            </section>
        </main>
