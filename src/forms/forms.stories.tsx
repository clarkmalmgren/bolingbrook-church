...
import { Form, TextField, Header, Checkboxes, CheckboxOption, Submit } from './index'
import { withKnobs } from '@storybook/addon-knobs'
import { muiTheme } from 'storybook-addon-material-ui'
import BolingbrookTheme from '../theme'

export default {
  component: Form,
  title: 'Form',
  decorators: [withKnobs, muiTheme([BolingbrookTheme])]
}
